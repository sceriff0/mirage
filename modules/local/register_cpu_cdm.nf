process CPU_REGISTER_CDM {
    ...
    // CDM parameters: coarse affine → diffeo → micro affine
    def coarse_crop_size = params.cpu_reg_cdm_coarse_crop_size ?: (params.cpu_reg_crop_size ?: 3000)
    def diffeo_crop_size = params.cpu_reg_cdm_diffeo_crop_size ?: (params.cpu_reg_crop_size ?: 2000)
    def micro_crop_size = params.cpu_reg_cdm_micro_crop_size ?: (params.cpu_reg_crop_size ?: 1500)
    def overlap_percent = params.cpu_reg_cdm_overlap_percent ?: (params.cpu_reg_overlap_percent ?: 10.0)
    def n_features = params.cpu_reg_cdm_n_features ?: (params.cpu_reg_n_features ?: 2000)
    def n_workers = task.cpus  // Use all allocated CPUs
    def opt_tol = params.cpu_reg_cdm_opt_tol ?: (params.cpu_reg_opt_tol ?: 1e-5)
    def inv_tol = params.cpu_reg_cdm_inv_tol ?: (params.cpu_reg_inv_tol ?: 1e-5)
    ...
    """
    echo "=================================================="
    echo "CPU Registration (CDM) - Dynamic Resource Allocation"
    echo "=================================================="
    ...
    echo "Micro crop size: ${micro_crop_size}"
    echo "=================================================="
    echo ""
